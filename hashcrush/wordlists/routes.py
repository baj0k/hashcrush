...
def _render_wordlists_add_form(form, next_url: str | None = None):
    ...
    if not selected_external_path and len(external_wordlist_files) == 1:
...
def wordlists_add():
    """Register a mounted static wordlist."""
    ...
    if form.validate_on_submit():
        ...
        flash('Wordlist registered!', 'success')
        return redirect(
            _wordlist_redirect_target(
                next_url,
                fallback_url=fallback_url,

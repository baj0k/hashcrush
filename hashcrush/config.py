...
class Config:
    ...
    _configured_secret = (
        sanitize_config_input(os.getenv('HASHCRUSH_SECRET_KEY'))
    ...
    _hashcat_bin = (
        sanitize_config_input(os.getenv('HASHCRUSH_HASHCAT_BIN'))
    ...
    _cookie_samesite = (
        sanitize_config_input(os.getenv('HASHCRUSH_SESSION_COOKIE_SAMESITE'))

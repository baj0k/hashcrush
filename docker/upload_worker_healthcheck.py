#!/usr/bin/env python3
"""Container healthcheck for the HashCrush upload worker."""
...
def main() -> int:
    ...
    heartbeat_path = Path(runtime_root) / "upload-worker-heartbeat.json"
    max_age_seconds = float(
        os.getenv("HASHCRUSH_UPLOAD_WORKER_HEARTBEAT_MAX_AGE_SECONDS", "30")
    )

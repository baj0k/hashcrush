...
rules_default = (
    os.getenv("HASHCRUSH_RULES_PATH") or existing_rules_path or DEFAULT_RULES_PATH
)
...
runtime_default = (
    os.getenv("HASHCRUSH_RUNTIME_PATH") or existing_runtime_path or DEFAULT_RUNTIME_PATH
)
runtime_path = input(
...
if env_ssl_cert_path and env_ssl_key_path:
    env_cert_dir = os.path.dirname(
        os.path.abspath(os.path.expanduser(env_ssl_cert_path))
    )
